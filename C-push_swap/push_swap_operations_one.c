...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   push_swap_operations_one.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: utygett <utygett@student.21-school.ru>     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/13 19:33:24 by utygett           #+#    #+#             */
/*   Updated: 2021/11/14 15:15:33 by utygett          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rev_rotate(t_push *swap, char sym, char real)
{
	...
	if (sym == 'a' && real == 'r' && swap->count++ && swap->cou == 'y')
		write(1, "rra\n", 4);
	else if (sym == 'b' && real == 'r' && swap->count++ && swap->cou == 'y')
		write(1, "rrb\n", 4);
	else if (sym == 'c' && real == 'r' && swap->count++ && swap->cou == 'y')
		write(1, "rrr\n", 4);
}
...
void	push_a(t_push *swap, char real)
{
	...
	if (real == 'r' && swap->count++ && swap->cou == 'y')
		write(1, "pa\n", 3);
}
